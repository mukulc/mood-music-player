...
SWIFT_CLASS("_TtC13first_project17GenreButtonScreen")
@interface GenreButtonScreen : UIViewController
- (void)viewDidLoad;
- (IBAction)genreButtontaped:(UIButton * _Nonnull)sender;
- (IBAction)stopbuttontapped:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC13first_project13SceneDelegate")
